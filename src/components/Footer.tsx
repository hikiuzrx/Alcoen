...
export function Footer() {
  return (
    <footer className="bg-other   grid grid-cols-7 gap-4 mt-20 min-h-[436px] p-10 ">
     <div className='col-span-5 '>
       <div className='flex justify-end  items-center'>
       <div className="flex flex-col items-end w-1/3 text-lg gap-y-6 ">
        <NavLink to="/" className="text-white font-medium text-2xl pr-9 ">Home</NavLink>
        <NavLink to="/a-propos" className="text-white font-medium text-2xl pr-1">À Propos</NavLink>
        <NavLink to="/service" className="text-white pr-2 font-medium text-2xl">Services</NavLink>
        <NavLink to="/secteur" className="text-white pr-4 font-medium text-2xl">Secteur</NavLink>
        <NavLink to="/contact" className="text-white pr-3 font-medium text-2xl">Contact</NavLink>
      </div>

      <ul className="flex flex-col gap-10 ml-8 w-1/3 ">
      ...
      <ul className="flex flex-col items-start w-1/3 gap-2  ">
        ...
        <li className="text-lg">+213 (0) 661 570 030</li>
        <li className="text-lg">+213 (0) 770 643 051</li>
      </ul>
       </div>
     </div>

      
      <div className="flex justify-start col-span-2 items-center mr-20">
        <NavLink to="/">
          <img className="bg-transparent w-60" src={logo} alt="Logo" />
        </NavLink>
      </div>
    </footer>
  );
