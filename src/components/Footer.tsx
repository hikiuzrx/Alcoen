  ...
  return (
    <footer className="bg-other  flex-wrap flex justify-evenly gap-4 mt-20 min-h-[436px] p-10 ">
       ...
       <div className="flex flex-col items-end  md:gap-y-6 xs:gap-y-2">
        <NavLink to="/" className="text-white font-medium md:text-1.4xl xs:text-lg  lg:text-2xl md:pr-9 xs:pr-8 ">Home</NavLink>
        <NavLink to="/a-propos" className="text-white md:text-1.4xl xs:text-lg   lg:text-2xl  font-medium text-2xl md:pr-1 xs:pr-2">À Propos</NavLink>
        <NavLink to="/service" className="text-white md:pr-2 xs:pr-3 md:text-1.4xl xs:text-lg   font-medium lg:text-2xl">Services</NavLink>
        <NavLink to="/secteur" className="text-white md:pr-4 xs:pr-5 md:text-1.4xl xs:text-lg  lg:text-2xl font-medium text-2xl">Secteur</NavLink>
        <NavLink to="/contact" className="text-white md:pr-3 xs:pr-4 md:text-1.4xl xs:text-lg  lg:text-2xl font-medium text-2xl">Contact</NavLink>
      </div>
      ...
      <ul className="flex flex-col md:gap-10 xs:gap-y-3  ">
        <li className="text-2xl font-semibold flex items-center">
          ...
          <span className='md:text-1.4xl xs:text-lg  lg:text-2xl'>Facebook</span>
        </li>
        <li className="text-2xl font-semibold flex items-center">
          ...
          <span className='md:text-1.4xl xs:text-lg  lg:text-2xl'>LinkedIn</span>
        </li>
        <li className="text-2xl font-semibold flex items-center">
          ...
          <span className='md:text-1.4xl xs:text-lg  lg:text-2xl'>Twitter</span>
        </li>
        <li className="text-2xl font-semibold flex items-center">
          <svg className="w-12 mx-2" xmlns="http://www.w3.org/2000/svg" fill='#FFFF' width="32" height="32" viewBox="0 0 32 32">
          ...
          <span className='md:text-1.4xl xs:text-lg  lg:text-2xl'>Instagram</span>
        </li>
      </ul>
      <ul className="flex flex-col items-start  xl:w-3/12 xs:w-1/3    gap-2 xs:ml-6 md:ml-10 s:ml-2  ">
        <li className="xl:text-4xl lg:text-3xl font-semibold md:text-2.5xl xs:text-1.4xl md:mb-4 xs:mb-2 xs:text-start "><h3>Adresse</h3></li>
