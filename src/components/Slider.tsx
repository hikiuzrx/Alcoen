...
let getCustomGradiant = (index:number):string =>{
     switch(index){
          case 0: 
               customGradiant ='bg-gradient-to-br from-primary via-primary-100  to-transparent lg:h-[162px]  xl:h-[202px] object-fill absolute m-2  p-2 shadow-lg rounded-lg inset-0'
               break;
          case 1: case 4:
               customGradiant = 'bg-gradient-to-tl from-primary via-transparent to-secondary lg:h-[162px] xl:h-[202px] object-fill absolute m-2  p-2 shadow-lg rounded-lg inset-0'
               break;
          case 2 : case 8: 
               customGradiant = 'bg-gradient-to-tr from-primary via-transparent to-other lg:h-[162px] xl:h-[202px] object-fill absolute m-2  p-2 shadow-lg rounded-lg inset-0 '
               break;
          case 3: 
               customGradiant = 'bg-other opacity-60 lg:h-[162px] xl:h-[202px] object-fill absolute m-2  p-2 shadow-lg rounded-lg inset-0'
               break;
          case 5:
               customGradiant = 'bg-gradient-to-t from-primary via-secondary opacity-60  to-other lg:h-[162px]  xl:h-[202px] object-fill absolute m-2  p-2 shadow-lg rounded-lg inset-0'
               break;
          case 6:
               customGradiant ='bg-primary-100 lg:h-[162px] xl:h-[202px] object-fill absolute m-2  p-2 shadow-lg rounded-lg inset-0'
               break;
          case 7:
               customGradiant = 'bg-gradient-to-tr  from-primary-100 via-other-100 to-other-100 opacity-70  lg:h-[162px]  xl:h-[202px] object-fill absolute m-2  p-2 shadow-lg rounded-lg inset-0'
               break;
          case 9:
               customGradiant = 'bg-gradient-to-tr  from-primary-100 via-other-100  to-other-100 opacity-70  lg:h-[162px]  xl:h-[202px] object-fill absolute m-2  p-2 shadow-lg rounded-lg inset-0 '
    ...
    <div className="relative overflow-hidden w-full h-60 ">
      ...
      >
        {cards.map((card, index) => (
          <div key={index} className="  relative gap-4 w-1/3 flex-shrink-0 p-2 xl:mr-3 lg:mr-custom-mr-2 ">
               
               <img src={card} alt="card" className=' rounded-lg lg:h-[162px] xl:h-[202px] overflow-hidden w-full object-fill inset-0 h-53 ' /> 
     ...
     <p className='text-xl text-white font-semibold flex mx-4 mb-2' style={{textAlign:'center'}}>
      ...
      <button
        onClick={prevSlide}
        className="absolute top-1/2 left-0 transform lg:-translate-y-9 xl:-translate-y-1/2  p-2 focus:outline-none"
      ...
      <button
        onClick={nextSlide}
        className="absolute top-1/2 right-0 transform lg:-translate-y-9 xl:-translate-y-1/2 p-2 focus:outline-none"
        style={{ backgroundColor: 'transparent', border: 'none' }}
      >
