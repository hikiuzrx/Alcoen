     ...
     return (
          <>
               ...
               <div className='flex  relative '>
                    ...
                    <div className='flex justify-end lg:w-1/2 md:w-1/3 xs:w-2/5  '>
          ...
          <section className='my-10 py-10'>
               <div className='grid grid-cols-12'>
                    ...
                    <div className='col-start-8 xs:translate-y-28 col-end-12 flex justify-center  md:mr-12  lg:mr-20'>
                         ...
                         className='lg:w-homeS xl:h-homeS xs:w-home3xs xs:h-home3x md:h-home2xs   lg:h-homeXs xs:-translate-x-2 xs:translate-y-2 xl:-translate-x-6 xl:translate-y-6 md:-translate-x-4 md:translate-y-4 drop-shadow-lg' />
                         </div>
                    </div> 
               </div>
          </section>
