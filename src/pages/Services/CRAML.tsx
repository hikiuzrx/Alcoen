...
export default function CRAML(){
     ...
     <div className="grid grid-cols-12">
          <section className="col-start-2 my-10 xs:ml-4 md:ml-10 col-span-10">
               <h2 className="text-primary leading-normal font-semibold mb-10 xs:text-3.5xl md:text-5xl">
          ...
          <section className="col-start-2 xs:ml-4 md:ml-10 col-span-10 my-10 ">
               <h2 className="text-secondary font-semibold xs:text-3.5xl xs:text-nowrap md:text-5xl">
                    Maison <span className="text-primary">d'Alcoen</span>
               </h2>
               <ul className="md:ml-10 xs:ml-0 md:mr-5  xs:mr-4 px-4 ">
