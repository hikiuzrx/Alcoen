...
export default function CREIE(){
     ...
     <div className="grid grid-cols-12">
          <section className="col-start-2 my-10 md:ml-10 xs:ml-4 col-span-10">
               <h2 className="text-primary font-semibold leading-normal mb-10 md:text-5xl xs:text-3.5xl">
               Contrôle réglementaire des équipement & installations électriques
               </h2>
               <p className="md:text-lg xs:text-s text-black leading-relaxed mb-10 xs:mr-4 md:mr-10  pr-5 ">
               ...
               <p className="md:text-lg xs:text-s text-black leading-relaxed xs:mr-4 md:mr-10  pr-5 ">
               ...
               <p className='text-black md:text-lg xs:text-s leading-relaxed xs:mr-4 md:mr-10  pr-5'>
                    <span className='text-xl'>-</span>
               ...
               <p className='text-black md:text-lg xs:text-s leading-relaxed mb-10 xs:mr-4 md:mr-10  pr-5'>
                    <span className='text-xl'>-</span>
          ...
          <section className="col-start-2 md:ml-10 xs:ml-4 col-span-10 my-10 ">
               ...
               <ul className="md:ml-10 xs:ml-0 mr-5 px-4 ">
                    ...
                    <li className="text-black leading-relaxed relative xs:text-s  md:text-lg flex items-center my-5  gap-x-2">
                    <img src={listIcone} alt="icone" className='top-3 absolute' />     
                    <p className='px-8 md:pr-8 xs:pr-4 pt-2'>
